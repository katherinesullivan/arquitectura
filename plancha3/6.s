...
a0:
    ...
    movss %xmm2, (%rsi) # se carga el contenido de %xmm2 en la dir de memoria de var2
    mulss %xmm2, %xmm4 # xmm4 = ey
    subss %xmm4, %xmm5 # xmm5 = f-ey
    divss %xmm3, %xmm5 # queda en %xmm5 el valor de x
    movss %xmm5, (%rdi) # se carga el contenido de %xmm5 en la dir de memoria de var1
    jmp retornonormal
...
eliminacionprogresiva:
    ...
    movss %xmm5, (%rsi) # se carga el contenido de xmm5 en la dir de memoria de var2
    mulss %xmm5, %xmm1
    subss %xmm1, %xmm2
    divss %xmm0, %xmm2 # en xmm2 queda el valor de x
    movss %xmm2, (%rdi) # se carga el contenido de xmm2 en la dir de memoria de var1
    jmp retornonormal
